    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.master.offer.save')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('price_gbp') is-invalid @enderror" id="price_gbp" name="price_gbp" placeholder="Price GBP" value="{{old('price_gbp')}}" 
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('price_usd') is-invalid @enderror" id="price_usd" name="price_usd" placeholder="Price USD" value="{{old('price_usd')}}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('price_eur') is-invalid @enderror" id="price_eur" name="price_eur" placeholder="Price EUR" value="{{old('price_eur')}}" >
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control @error('offer_description') is-invalid @enderror" id="offer_description" name="offer_description" placeholder="Offer description" value="{{old('offer_description')}}" ></textarea>
