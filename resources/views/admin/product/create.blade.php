                    ...
                    <form method="post" action="{{route('admin.product.series.save',[$instrument->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @error('title') is-invalid @enderror" id="title" name="title" placeholder="Series Title" value="{{old('title')}}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" class="form-control form-control-sm @error('media_link') is-invalid @enderror" id="media_link" name="media_link" value="{{old('media_link')}}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('price_usd') is-invalid @enderror" id="price_usd" name="price_usd" placeholder="Price in USD" value="{{old('price_usd')}}" 
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('price_euro') is-invalid @enderror" id="price_euro" name="price_euro" placeholder="Price in EURO" value="{{old('price_euro')}}">
                                @error('price_euro')<span class="text-danger" role="alert">{{$message}}</span>@enderror
                            </div>

                            <div class="form-group col-md-4">
                                <label for="gbp" class="col-form-label">GBP:</label>
                                <input type="text" class="form-control form-control-sm @error('gbp') is-invalid @enderror" id="gbp" name="gbp" placeholder="Price in GBP" value="{{old('gbp')}}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="url" name="item_clean_url" id="item_clean_url" placeholder="Item clean URL" class="form-control form-control-sm" value="{{ old('item_clean_url') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="seo_meta_description" id="seo_meta_description" placeholder="SEO meta description" class="form-control form-control-sm" value="{{ old('seo_meta_description') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="seo_meta_keywords" id="seo_meta_keywords" placeholder="PROVIDE A COMMA-SEPARATED LIST OF KEYWORDS" class="form-control form-control-sm" value="{{ old('seo_meta_keywords') }}">
