            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Edit Instrument
                        <a class="headerbuttonforAdd" href="{{route('admin.instrument')}}"><i class="fa fa-step-backward" aria-hidden="true"></i>BACK</a>
                    </h5>
                    <!-- <p>This example shows FixedHeader being styled by the Bootstrap 4 CSS framework.</p> -->
                </div>
                <div class="card-body">
                    <form method="post" action="{{route('admin.instrument.update',$instrument->id)}}" enctype="multipart/form-data">
                        @csrf
