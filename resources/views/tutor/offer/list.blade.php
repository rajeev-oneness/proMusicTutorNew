        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Offer
                        <a class="headerbuttonforAdd" href="{{route('tutor.offer.create')}}">
                            ...
                            <tbody>
                                @foreach($offers as $key => $offer)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('tutor.offer.edit', $offer->id)}}"><i class="fas fa-edit"></i></a>  <a href="javascript:void(0)" class="seriesDelete" data-id="{{$offer->id}}"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        type:'POST',
                        dataType:'JSON',
                        url:"{{route('tutor.offer.delete')}}",
                        data: {id:productSeriesId,userId:'{{$user->id}}',_token:'{{csrf_token()}}'},
