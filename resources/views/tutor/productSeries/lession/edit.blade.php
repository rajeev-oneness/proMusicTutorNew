                    ...
                    <form method="post" action="{{route('tutor.product.series.lession.update',[$instrument->id,$productLession->productSeriesId,$productLession->id])}}" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('title') is-invalid @enderror" id="title" name="title" placeholder="Series Title" value="{{(old('title') ?? $productLession->title)}}">
                                @error('title')<span class="text-danger" role="alert">{{$message}}</span>@enderror
                            </div>
                            <div class="form-group col-md-4">
                                <label for="price" class="col-form-label">Price:</label>
                                <input type="text" class="form-control form-control-sm @error('price') is-invalid @enderror" id="price" name="price" placeholder="Price" value="{{(old('price') ?? $productLession->price)}}" onkeypress="return isNumberKey(event);" maxlength="7">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('price_gbp') is-invalid @enderror" id="price_gbp" name="price_gbp" placeholder="GBP" value="{{(old('price_gbp') ?? zeroGoesToBlank($productLession->price_gbp))}}" onkeypress="return isNumberKey(event);" maxlength="7">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('price_usd') is-invalid @enderror" id="price_usd" name="price_usd" placeholder="Price in USD" value="{{(old('price_usd') ?? zeroGoesToBlank($productLession->price_usd))}}" onkeypress="return isNumberKey(event);" maxlength="7">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('price_euro') is-invalid @enderror" id="price_euro" name="price_euro" placeholder="Price in EURO" value="{{(old('price_euro') ?? zeroGoesToBlank($productLession->price_euro))}}" onkeypress="return isNumberKey(event);" maxlength="7">
                        ...
                        <div class="row">
                            <div class="form-group col-md-5 image-upload-wrapper">
                               ...
                               <input type="file" class="form-control form-control-sm @error('preview_video') is-invalid @enderror" id="preview_video" name="preview_video">
                               <button><i class="fas fa-pencil-alt"></i></button> 
                            ...
                            <div class="form-group col-md-5 ml-2 image-upload-wrapper">
                                ...
                                <input type="file" class="form-control form-control-sm @error('video') is-invalid @enderror" id="video" name="video">
                                <button><i class="fas fa-pencil-alt"></i></button> 
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('keywords') is-invalid @enderror" id="keywords" name="keywords" placeholder="PROVIDE A COMMA-SEPARATED LIST OF KEYWORDS" value="{{(old('keywords') ?? $productLession->keywords)}}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control form-control-sm @error('genre') is-invalid @enderror" name="genre" id="genre">
                                    ...
                                    @foreach($genre as $item)
                                        <option value="{{$item->id}}" {{(old('genre') ?? $productLession->genre) == $item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('item_clean_url') is-invalid @enderror" id="item_clean_url" name="item_clean_url" placeholder="Item clean URL" value="{{(old('item_clean_url') ?? $productLession->item_clean_url)}}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm @error('product_code') is-invalid @enderror" id="product_code" name="product_code" placeholder="Product code" value="{{(old('product_code') ?? $productLession->product_code)}}">
                                @error('product_code')<span class="text-danger" role="alert">{{$message}}</span>@enderror
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description" class="col-form-label">Description:</label>
                            <textarea class="form-control form-control-sm @error('description') is-invalid @enderror" id="description" name="description" placeholder="Description">{{(old('description') ?? $productLession->description)}}</textarea>
