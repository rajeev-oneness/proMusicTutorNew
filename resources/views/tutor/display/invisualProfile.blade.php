		                    ...
		                    <div class="col-12 col-sm-6 col-md-4 mb-3">
		                        <div class="card border bg-transparent more-course">
	                                ...
	                                <div class="card-body text-center">
		                                ...
		                                <?php $seriesPrice = calculateLessionPrice($productSeries, $data->currency); ?>
	                                    @guest
	                                    ...
	                                    @else
	                                        ...
	                                        @else
												...
												<!-- Add To Cart -->
	                                            <a class="btn btn-lg" onclick="addOrRemoveUserProductCart('{{$user->id}}','series','{{$productSeries->id}}','add','{{$data->currency}}')"><i class="fas fa-cart-plus"></i></a>
	                                        @endif
	                                    @endguest
		                            </div>
