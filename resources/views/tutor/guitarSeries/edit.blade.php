                    ...
                    <form method="post" action="{{route('tutor.guitar.series.update',$guitarSeries->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('genre') is-invalid @enderror" name="genre" id="genre" required>
                                    ...
                                    @foreach($genre as $item)
                                        <option value="{{$item->id}}" {{ $guitarSeries->genre == $item->id ? 'selected' : '' }}>{{ ucwords($item->name) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('difficulty') is-invalid @enderror" name="difficulty" id="difficulty">
                                    ...
                                    <option value="easy" {{ $guitarSeries->difficulty == 'easy' ? 'selected' : '' }}>Easy</option>
                                    <option value="medium" {{ $guitarSeries->difficulty == 'medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="hard" {{ $guitarSeries->difficulty == 'hard' ? 'selected' : '' }}>Hard</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('gbp') is-invalid @enderror" id="gbp" name="gbp" placeholder="GBP" value="{{$guitarSeries->gbp}}">
                                @error('gbp')<span class="text-danger" role="alert">{{$message}}</span>@enderror
                            </div>

                            <div class="form-group col-md-4">
                                <label for="price_usd" class="col-form-label">USD:</label>
                                <input type="text" class="form-control @error('price_usd') is-invalid @enderror" id="price_usd" name="price_usd" placeholder="Price in USD" value="{{$guitarSeries->price_usd}}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('price_euro') is-invalid @enderror" id="price_euro" name="price_euro" placeholder="Price in EURO" value="{{$guitarSeries->price_euro}}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="item_clean_url" id="item_clean_url" placeholder="Item clean URL" class="form-control" value="{{ $guitarSeries->item_clean_url }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="seo_meta_description" id="seo_meta_description" placeholder="SEO meta description" class="form-control" value="{{ $guitarSeries->seo_meta_description }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="seo_meta_keywords" id="seo_meta_keywords" placeholder="SEO meta keywords" class="form-control" value="{{ $guitarSeries->seo_meta_keywords }}">
