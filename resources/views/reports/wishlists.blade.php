...
@section('title','Series wishlisted')
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Series wishlisted</h5>
                </div>
                <div class="card-body">
                    <p>
                    ...
                    <div class="collapse hide" id="collapseExample">
                        <div class="card card-body px-0 py-2 border-0 shadow-none">
                            <form action="{{route('admin.report.wishlistReport')}}" method="POST">
                            @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3 text-right">
                                        ...
                                        <a href="{{route('admin.report.wishlistReport')}}" class="btn btn-sm btn-secondary"> <i class="fa fa-ban"></i> Remove filters</a>
                                    </div>
                                </div>
                            </form>
                        </div>
