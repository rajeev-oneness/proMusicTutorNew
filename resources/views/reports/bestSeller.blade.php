                    ...
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <select name="instrumentId" id="instrumentId"
                                                ...
                                                @foreach ($instruments as $instrument)
                                                    <option value="{{ $instrument->id }}"
                                                        {{ $instrument->id == $req->instrumentId ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="date" class="form-control form-control-sm mr-2"
                                                placeholder="Date from" name="dateFrom" id="dateFrom"
                                                max="{{ date('Y-m-d') }}"
                                                value="{{ !empty($req->dateFrom) ? $req->dateFrom : '' }}">
                                        </div>

                                        <div class="col-md-3">
                                            <label for="dateTo">Date to</label>
                                            <input type="date" class="form-control form-control-sm mr-2"
                                                placeholder="Date to" name="dateTo" id="dateTo"
                                                max="{{ date('Y-m-d') }}"
                                                value="{{ !empty($req->dateTo) ? $req->dateTo : '' }}">
                                        </div>
                                        ...
                                        <div class="col-md-3 text-right">
                                            ...
                                            <a href="{{ route('admin.report.bestSeller') }}"
                                                class="btn btn-sm btn-secondary"> <i class="fa fa-ban"></i> Remove
                                                filters</a>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="table-responsive mt-3">
                            <table id="example5" class="table table-sm table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    @forelse ($data_lesson as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                {{ $item['from'] }}
                        ...
                        <div class="table-responsive mt-3">
                            <table id="example5" class="table table-sm table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    @forelse ($data_offer as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                {{ $item['from'] }}
