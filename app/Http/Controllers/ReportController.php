...
class ReportController extends Controller
{
    ...
    {
        $purchase_list = UserProductLessionPurchase::select('productSeriesId')->groupBy('productSeriesId')->pluck('productSeriesId')->toArray();
        ...
        return view('reports.bestSeller', compact('data'));
    }
}
